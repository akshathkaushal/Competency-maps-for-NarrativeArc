...
check-safety:
	...
	$(BANDIT_COMMAND_FLAG)poetry run bandit -ll -r competency_maps/
...
check-style:
	...
	$(MYPY_COMMAND_FLAG)poetry run mypy --config-file setup.cfg competency_maps tests/**/*.py
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/pages/competency_maps.rst
	rm -f docs/pages/modules.rst
	sphinx-apidoc -o docs/pages/ competency_maps
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
